...
namespace Visitas.Controllers
{
    ...
    {
        private VisitasContext db = new VisitasContext();
        ...
        public ActionResult Create([Bind(Include = "ContactoID,Nombre,Apellido,Identificacion,CreDate")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactoID,Nombre,Apellido,Identificacion,CreDate")] Contacto contacto)
        {
            if (ModelState.IsValid)
            {
